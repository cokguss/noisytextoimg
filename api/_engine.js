// engine.js — logika shared text-to-image (kamus ID->EN, crypto provider,
// createAiBodyJob/cekjob). Ikut ter-deploy ke Vercel, bisa di-require oleh
// server.js (lokal) maupun api/_lib.js (functions). Tanpa side effect.
